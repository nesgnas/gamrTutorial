...
public class UI1 implements MouseListener {
    ...
    public void option_top(int frameX, int frameY) {
        ...
        if (gp.soundMusic) {
            ...
            g2.drawImage(sound_music_on, textX, textY - 70, gp.getTitleSize(), gp.getTitleSize(), null); // method to
                                                                                                         // draw
        } else if (!gp.soundMusic) {
            g2.drawString("Music", textX + 2, textY);
            g2.drawImage(sound_music_off, textX, textY - 70, gp.getTitleSize(), gp.getTitleSize(), null); // method to
                                                                                                          // draw
        }
        // System.out.println("textX: " + textX + " - " + "textY" + textY);
        ...
        if (gp.soundEffect) {
            ...
            g2.drawImage(sound_effect_on, textX + 5, textY - 70, gp.getTitleSize(), gp.getTitleSize(), null); // method
                                                                                                              // to draw
        } else if (!gp.soundEffect) {
            g2.drawString("Effect", textX, textY);
            g2.drawImage(sound_effect_off, textX + 5, textY - 70, gp.getTitleSize(), gp.getTitleSize(), null); // method
                                                                                                               // to
                                                                                                               // draw
        }
        // System.out.println("textX: " + textX + " - " + "textY" + textY);
