...
//        }
    ...
    public void option_top(int frameX, int frameY){
        ...
        g2.drawImage(reset, textX +70, textY+gp.getTitleSize() - 70, titlesize - 10, titlesize - 10, null); // method to draw
        //System.out.println("textX: " + textX + " - " + "textY" + textY);
        ...
        g2.drawImage(menu, textX+150, textY-gp.getTitleSize()*2 - 70, titlesize - 10, titlesize - 10, null); // method to draw
        //System.out.println("textX: " + textX + " - " + "textY" + textY);
        textX += 150;
        ...
        if (commandNum_music == 1){
            ...
            g2.drawImage(sound_music_on, textX + 70, textY + gp.getTitleSize()*2 - 70, titlesize - 10, titlesize - 10, null); // method to draw
        }
        if (commandNum_music == 2){
            g2.drawString("Music: OFF", textX+60,textY + gp.getTitleSize()*2);
            g2.drawImage(sound_music_off, textX + 70, textY + gp.getTitleSize()*2 - 70, titlesize - 10, titlesize - 10, null); // method to draw
        }
        textX += 70;
        //System.out.println("textX: " + textX + " - " + "textY" + textY);
        ...
        if (commandNum_effect == 3) {
            ...
            g2.drawImage(sound_effect_on, textX+150, textY + gp.getTitleSize()*2 - 70, titlesize - 10, titlesize - 10, null); // method to draw
        }
        if (commandNum_effect == 4) {
            g2.drawString("Effect: OFF", textX+135, textY + gp.getTitleSize()*2);
            g2.drawImage(sound_effect_off, textX+150, textY + gp.getTitleSize()*2 - 70, titlesize - 10, titlesize - 10, null); // method to draw
        }
        textX+= 150;
        //System.out.println("textX: " + textX + " - " + "textY" + textY);
        textY += gp.getTitleSize()*2;
