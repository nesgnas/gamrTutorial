...
//        System.out.println("InBoxUse");
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (gameState == optionsState) {
            ...
            if (mx >= 532 && mx <= 532 + 50 && my >= 286 && my <= 336) { //Menu
                gameState = titleState;
                System.out.println("Menu");
            } else
            if (mx >= 444 && mx <= 444 + 50 && my >= 382 && my <= 432) { //Continue
//                      if (gameState == optionsState)
                gameState = playState;
                System.out.println("Continue");
            }
            else
            if (mx >= 382 && mx <= 382 + 50 && my >= 488 && my <= 538) { //Music
                if (commandNum_music == 1)
                    commandNum_music = 2;
                else
                if (commandNum_music == 2)
            ...
            if (mx >= 532 && mx <= 532 + 50 && my >= 488 && my <= 538) { //Effect
                if (commandNum_effect == 3)
                    commandNum_effect = 4;
                else
