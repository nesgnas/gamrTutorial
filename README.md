...
| --- | ------------------------------ |-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1   | **Bui Doan The Sang**  | ITCSIU21104 | Github repository host, make a report, create initial core structure of project, build flexing method load Map, develop idea checking collision for Object (Box). crawl position top and bottom for each room, deep copy ArrayList Boxes to BoxesCopy, apply Command Pattern in setting keyInput, using Comparable Interface to sort ArrayList Boxes. |
